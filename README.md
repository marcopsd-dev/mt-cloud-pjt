...
<b>NOTE: Diagram taken from the course "AWS Solutions Architect Associate SAA-C03" + "AWS Developer DVA-CO2" taught by <a href="https://lern.cantrill.io">Adrian Cantrill</a><br>
  <br><b>2ND NOTE: *work in progress* You can find the CFN Json template tutorial at the bottom of this project for a much faster and automated way of deploying the multi-tier cloud infrastructure shown on the diagram, I decided to first showcase how to use the user interface for anyone that has no experience with AWS or coding. </b> 
